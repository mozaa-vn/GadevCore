//
//  GadevNetworkingTests.swift
//  GadevCoreTests
//
//  Created by Nguyễn Ý on 9/25/20.
//
...
final class GadevNetworkingTests: XCTestCase {

    func testLoadDataCall  () {
        
        let manager = GadevCore.Networking.Manager()
    ...
    func testSendDataCall () {
        let session = NetworkSessionMock()
        let manager = GadevCore.Networking.Manager()
        let sampleObject = MockData(id: 1, name: "Ken")
