#
#  Be sure to run `pod spec lint GadevCore.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "mozaa" => "mry.nsth@gmail.com" }
  # Or just: spec.author    = "mozaa"
  # spec.authors            = { "mozaa" => "mry.nsth@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/mozaa"
